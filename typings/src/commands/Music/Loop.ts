...
export default class Loop extends AloeCommand {
  constructor(client: any) {
    ...
    this.exec = async (
      ...
      if (
        ...
        return message.reply({
          content: `${this.client.emoji.tick} Loop mode has been set to: \`Off\``
        });
      }
      ...
      if (
        ...
        return message.reply({
          content: `${this.client.emoji.tick} Loop Mode has been set to: \`Track\``
        });
      }
      ...
      if (
        ...
        return message.reply({
          content: `${this.client.emoji.tick} Loop mode has been set to: \`Queue\``
        });
      } else {
        return message.reply({
          embeds: [
