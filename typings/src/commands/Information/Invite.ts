...
export default class Invite extends AloeCommand {
      ...
      return message.reply({
        embeds: [
          this.client.utils.premiumEmbed(message.guild.id)
            .setDescription(`Click on the Buttons Below! to [Invite](https://discord.com/api/oauth2/authorize?client_id=${this.client.user.id}&permissions=35184425925952&scope=applications.commands%20bot) Me!`)
        ],
        components: [
